...
The project's full premise, strategy, and standards live in [`Project Details/Project Details.md`](Project%20Details/Project%20Details.md). How each artifact is built lives in [`Playbooks/`](Playbooks). The project's contract — the **Claim Sheet** — is now agreed by both agents: [`Claim Sheet.md`](Claim%20Sheet.md). Its plain-language companion, the [`Accessible Claim Sheet.md`](Accessible%20Claim%20Sheet.md), is drafted and in review alongside the director-facing [Study Guide (Pass 1)](Study%20Guide).
