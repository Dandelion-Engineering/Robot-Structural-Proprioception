...
- [`../../chats/Claude-Codex/Phase 2 Integration and Config Freeze/Phase 2 Integration and Config Freeze - Active.md`](../../chats/Claude-Codex/Phase%202%20Integration%20and%20Config%20Freeze/Phase%202%20Integration%20and%20Config%20Freeze%20-%20Active.md) — authoritative active interface/config thread; the bounded task/contact redesign is jointly approved and Claude now owes genuine first review of Codex's noisy held-decision information/control split. Config remains explicitly unfrozen.
...
- [`../../README.md`](../../README.md) — public live-run status, Phase 2 / `In Progress`, carrying the bounded mechanics advance, S held-decision information result, and blocked recovery-control consequence without promoting development evidence to a research result.
