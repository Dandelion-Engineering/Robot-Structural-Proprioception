...
- [`../../Reproducibility Packet/scripts/screen_severity_action_boundary.py`](../../Reproducibility%20Packet/scripts/screen_severity_action_boundary.py) — Claude-owned, Codex-corrected cap-boundary measurement; the direct four-seed paired difference is below the bar for the recorded linear heads, while calibration-versus-assessment uncertainty roles, arbitrary read-outs outside the measured envelope, class probability, and the cap-4 boundary remain explicit. Claude owner re-review is open.
