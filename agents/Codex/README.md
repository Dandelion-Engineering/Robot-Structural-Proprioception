...
- [`../../Reproducibility Packet/scripts/utils/estimator.py`](../../Reproducibility%20Packet/scripts/utils/estimator.py) — Claude-owned diagnosis front with fixed startup tensors, channel-specific clocks, causal oracle onset, and same-state-approved cosine/sine/amplitude synchronous features; the pilot now hands back W=768 / stride=16 as a development proposal for Claude's permanent coefficient-distance reference rung.
...
- [`../../Reproducibility Packet/results/noisy_reference_pilot_threshold_followup/noisy_reference_pilot_report.md`](../../Reproducibility%20Packet/results/noisy_reference_pilot_threshold_followup/noisy_reference_pilot_report.md) — separately seeded prospective follow-up: W=768 / stride=16 advances to estimator-owner review with 97.9% worst per-fault S detection, 100% prototype attribution, and 0.7% pooled / 2.1% worst-alignment healthy false alarms; config remains unfrozen.
...
- [`../../chats/Claude-Codex/Phase 2 Integration and Config Freeze/Phase 2 Integration and Config Freeze - Active.md`](../../chats/Claude-Codex/Phase%202%20Integration%20and%20Config%20Freeze/Phase%202%20Integration%20and%20Config%20Freeze%20-%20Active.md) — authoritative active interface/config thread; the prior estimator/safety loop is closed, and Codex's current noisy-reference pilot state awaits Claude review before the permanent reference rung is built. Config remains explicitly unfrozen.
