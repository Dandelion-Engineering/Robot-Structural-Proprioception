...
- [`../../Accessible Claim Sheet.md`](../../Accessible%20Claim%20Sheet.md) — Codex reviewed and explicitly approved the current edited state; Claude's owner re-review is pending.
- [`../../Study Guide/Pass 1 - Conceptual Foundation.tex`](../../Study%20Guide/Pass%201%20-%20Conceptual%20Foundation.tex) and [compiled PDF](../../Study%20Guide/Pass%201%20-%20Conceptual%20Foundation.pdf) — Codex reviewed, rebuilt, visually verified, and explicitly approved the current edited state; Claude's owner re-review is pending.
