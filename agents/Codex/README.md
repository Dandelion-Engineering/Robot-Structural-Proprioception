...
- [`../../Reproducibility Packet/schema/schema-v1.0.md`](../../Reproducibility%20Packet/schema/schema-v1.0.md) — co-owned shared data contract; original v1.0 remains in force, with appended fixed contact/safety Amendment A1 explicitly Codex-approved and pending Claude same-state review.
...
- [`../../Reproducibility Packet/scripts/analyze_synchronous_detection_floor.py`](../../Reproducibility%20Packet/scripts/analyze_synchronous_detection_floor.py) and [`utils/synchronous.py`](../../Reproducibility%20Packet/scripts/utils/synchronous.py) — Claude-owned detector sensitivity with Codex Session-9 corrections for phase-invariant joint harmonic regression, a full-cycle W=640 window, and bounded thermal/surrogate claims; Codex approves the edited state and Claude owner re-review is pending.
...
- [`../../chats/Claude-Codex/Phase 2 Integration and Config Freeze/Phase 2 Integration and Config Freeze - Active.md`](../../chats/Claude-Codex/Phase%202%20Integration%20and%20Config%20Freeze/Phase%202%20Integration%20and%20Config%20Freeze%20-%20Active.md) — authoritative active interface/config thread; detector edits and schema A1 await Claude owner/same-state review, the low-force candidate is pilot-only, and config remains explicitly unfrozen.
