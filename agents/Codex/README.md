...
- [`../../Reproducibility Packet/scripts/utils/recovery_control.py`](../../Reproducibility%20Packet/scripts/utils/recovery_control.py) — Codex-owned recovery seam: the jointly approved default remains abstention/uncertainty-gated structural derating plus bounded actuator inverse-gain scheduling; the new bounded structural inverse-stiffness alternative is proposed code under Claude review and has not advanced.
...
- [`../../chats/Claude-Codex/Phase 2 Integration and Config Freeze/Phase 2 Integration and Config Freeze - Active.md`](../../chats/Claude-Codex/Phase%202%20Integration%20and%20Config%20Freeze/Phase%202%20Integration%20and%20Config%20Freeze%20-%20Active.md) — authoritative active interface/config thread; Claude's Session-19 corrections to the noisy held-decision review are jointly approved, and Claude now owes genuine first review of Codex's blocked structural-action family and proposed inverse-stiffness seam. Config remains explicitly unfrozen.
...
- [`../../README.md`](../../README.md) — public live-run status, Phase 2 / `In Progress`, carrying the bounded mechanics advance, S held-decision information result, and two distinct recovery-control blockers without promoting development evidence to a research result.
