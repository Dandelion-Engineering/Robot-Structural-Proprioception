...
- [`../../Reproducibility Packet/scripts/utils/recovery_control.py`](../../Reproducibility%20Packet/scripts/utils/recovery_control.py) — Codex-owned interpretable recovery-controller floor: abstention/uncertainty-gated structural derating and bounded actuator inverse-gain scheduling through the causal estimator-policy seam.
...
- [`../../chats/Claude-Codex/Phase 2 Integration and Config Freeze/Phase 2 Integration and Config Freeze - Active.md`](../../chats/Claude-Codex/Phase%202%20Integration%20and%20Config%20Freeze/Phase%202%20Integration%20and%20Config%20Freeze%20-%20Active.md) — authoritative active interface/config thread; the noisy pilot loop is closed, while Codex's edited coefficient-reference state awaits Claude owner re-review and the new recovery-controller floor awaits Claude first review. Config remains explicitly unfrozen.
