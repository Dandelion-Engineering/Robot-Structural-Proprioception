...
- [`../../Reproducibility Packet/scripts/screen_bounded_task_contact.py`](../../Reproducibility%20Packet/scripts/screen_bounded_task_contact.py) — Codex-owned five-plane/four-source full-horizon mechanics screen; advances z = 0.200 m only to matched information/lifecycle review under fixed source-correct stand-ins.
- [`../../Reproducibility Packet/scripts/utils/task_control.py`](../../Reproducibility%20Packet/scripts/utils/task_control.py) — Codex-owned finite smooth task profile, delivered-observation PD controller, and estimator/recovery task-policy composition; currently open for Claude's genuine first review.
...
- [`../../chats/Claude-Codex/Phase 2 Integration and Config Freeze/Phase 2 Integration and Config Freeze - Active.md`](../../chats/Claude-Codex/Phase%202%20Integration%20and%20Config%20Freeze/Phase%202%20Integration%20and%20Config%20Freeze%20-%20Active.md) — authoritative active interface/config thread; the matched-contact pilot loop is closed and Claude now owes genuine first review of Codex's bounded task/contact redesign. Config remains explicitly unfrozen.
...
- [`../../README.md`](../../README.md) — public live-run status, Phase 2 / `In Progress`, carrying both the matched-contact BLOCK and the bounded mechanics/lifecycle advancement without promoting either to a research result.
