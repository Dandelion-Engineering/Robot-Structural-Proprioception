...
## Step 16 — Generate a real privileged trace from the selected MuJoCo plant
...
Use `--scenario structure --fault-severity 0.50` or `--scenario actuator --fault-severity 0.70` for a physical-fault development trace. Sensor faults are rejected here and must be injected only in Step 17.

## Step 17 — Apply the sensor-realism + fault-injection model
...
## Step 18 — Generate the optional analytic plant fixture
