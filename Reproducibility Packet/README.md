...
## Step 14 — Run the plant-interface and sensor-model tests
...
## Step 15 — Generate a real privileged trace from the selected MuJoCo plant
...
Use `--scenario structure --fault-severity 0.50` or `--scenario actuator --fault-severity 0.70` for a physical-fault development trace. Sensor faults are rejected here and must be injected only in Step 16.

## Step 16 — Apply the sensor-realism + fault-injection model
...
## Step 17 — Generate the optional analytic plant fixture
